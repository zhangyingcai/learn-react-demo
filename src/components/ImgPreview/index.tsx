import React, { useState, useEffect, useRef, ReactNode, createElement } from 'react'
        ...
        <div>
            {showModal && (
                <div className={styles.previewBox}>
                    <div className={styles.previewBackground} onClick={handleCloseClick}></div>
                    <div className={styles.previewImg} onWheel={handleOnWheel}>
                        <img src={src} style={{ transform: `scale(${zoom}) rotate(${rotate}deg)` }} alt="图片" />
                    </div>
                    <div className={styles.previewCloseBtn} onClick={handleCloseClick}>x</div>
